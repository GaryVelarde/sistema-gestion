...
import { BudgetRegisterRoutingModule } from './budget-register-routing.module';
...
@NgModule({
    ...
    declarations: [BudgetRegisterComponent],
    providers: [
        InscriptionPresenter,
        provideHttpClient(withInterceptorsFromDi()),
    ],
})
export class BudgetRegisterModule {}
